...
public class TextView_blueDark_9 extends androidx.appcompat.widget.AppCompatTextView{
    // attr create in attrs
    String strTitle;

    public TextView_blueDark_9(Context context) {
        super(context);
    ...
    public TextView_blueDark_9(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public TextView_blueDark_9(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setStyle(){
        int grayColor = getResources().getColor(R.color.colorBlueDark);
