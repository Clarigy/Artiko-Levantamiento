...
public class TextView_green_10 extends androidx.appcompat.widget.AppCompatTextView {

    // attr create in attrs
    String strTitle;

    public TextView_green_10(Context context) {
        super(context);
    ...
    public TextView_green_10(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public TextView_green_10(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setStyle(){
        int blueColor = getResources().getColor(R.color.colorGreen);
