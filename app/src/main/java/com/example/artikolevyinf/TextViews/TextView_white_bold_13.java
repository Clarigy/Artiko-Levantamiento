...
public class TextView_white_bold_13 extends androidx.appcompat.widget.AppCompatTextView {
    // attr create in attrs
    String strTitle;

    public TextView_white_bold_13(Context context) {
        super(context);
    ...
    public TextView_white_bold_13(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public TextView_white_bold_13(Context context, AttributeSet attrs, int defStyleAttr) {
