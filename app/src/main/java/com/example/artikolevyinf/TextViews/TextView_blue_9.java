...
public class TextView_blue_9 extends androidx.appcompat.widget.AppCompatTextView {

    // Se crean las variables para los atributos
    String strTitle;

    public TextView_blue_9(Context context) {
        super(context);
    ...
    public TextView_blue_9(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public TextView_blue_9(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
