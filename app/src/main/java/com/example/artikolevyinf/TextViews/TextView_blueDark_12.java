...
public class TextView_blueDark_12 extends androidx.appcompat.widget.AppCompatTextView {
    // Se crean las variables para los atributos
    String strTitle;

    public TextView_blueDark_12(Context context) {
        super(context);
    ...
    public TextView_blueDark_12(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public TextView_blueDark_12(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
