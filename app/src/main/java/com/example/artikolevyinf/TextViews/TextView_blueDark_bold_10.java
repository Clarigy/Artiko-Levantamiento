...
public class TextView_blueDark_bold_10 extends androidx.appcompat.widget.AppCompatTextView{

    // attr create in attrs
    String strTitle;

    public TextView_blueDark_bold_10(Context context) {
        super(context);
    ...
    public TextView_blueDark_bold_10(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public TextView_blueDark_bold_10(Context context, AttributeSet attrs, int defStyleAttr) {
